...
#pmemd.cuda -O  -i ./smd.in -o smd_1.out -p ./complex.parm7 -c eq_3.rst -r smd_1.rst -ref eq_3.rst -x smd_1.nc 
pmemd.cuda -O  -i ./smd.in -o smd_3.out -p ./complex.parm7 -c eq_3.rst -r smd_3.rst -ref eq_3.rst -x smd_3.nc
